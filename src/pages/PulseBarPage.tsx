...
const PulseBarPage = () => {
  ...
  const images = [
    'https://cdn.jsdelivr.net/gh/abhinavnosnitch/aj-website-assets/Website%20assets/Projects/pulse-bar/IMG-20250802-WA0011.jpg',
    'https://cdn.jsdelivr.net/gh/abhinavnosnitch/aj-website-assets/Website%20assets/Projects/pulse-bar/IMG-20250802-WA0012.jpg',
    'https://cdn.jsdelivr.net/gh/abhinavnosnitch/aj-website-assets/Website%20assets/Projects/pulse-bar/IMG-20250802-WA0013.jpg',
    'https://cdn.jsdelivr.net/gh/abhinavnosnitch/aj-website-assets/Website%20assets/Projects/pulse-bar/IMG-20250802-WA0014.jpg'
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="reveal-card mt-20 text-center max-w-3xl mx-auto">
            <p className="font-cormorant text-xl sm:text-2xl text-luxury-charcoal/80 italic leading-relaxed">
              A dynamic entertainment venue where bold design meets vibrant energy, creating an unforgettable nightlife experience.
            </p>
          </div>
        </div>
      </section>
