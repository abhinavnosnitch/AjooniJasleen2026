...
const RamaStorePage = () => {
  ...
  const images = [
    'https://cdn.jsdelivr.net/gh/abhinavnosnitch/aj-website-assets/Website%20assets/Projects/rama-store/001.jpg',
    'https://cdn.jsdelivr.net/gh/abhinavnosnitch/aj-website-assets/Website%20assets/Projects/rama-store/002.jpg'
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="reveal-card mt-20 text-center max-w-3xl mx-auto">
            <p className="font-cormorant text-xl sm:text-2xl text-luxury-charcoal/80 italic leading-relaxed">
              A modern retail space where thoughtful design enhances the shopping experience through clean lines and efficient layouts.
            </p>
          </div>
        </div>
      </section>
