  ...
  return (
    <div className="bg-luxury-ivory overflow-x-hidden w-full">
      ...
      <section className="py-20 overflow-x-hidden">
        ...
        >
          <h1 className="font-cormorant text-3xl sm:text-4xl lg:text-5xl font-bold text-luxury-charcoal mb-6">Featured Projects</h1>
          <p className="font-poppins text-lg sm:text-xl text-luxury-charcoal max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
            {featuredProjects.map((project, index) => (
              ...
              >
                {/* Premium Card Container with Sophisticated Hover Effects */}
                <div className="bg-white rounded-lg overflow-hidden shadow-lg transform transition-all duration-500 ease-out group-hover:shadow-2xl group-hover:-translate-y-2 group-hover:scale-[1.02]">
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    {/* Gradient Overlay - Subtle on normal state, more prominent on hover */}
                    ...
                    {/* Premium Shine Effect - Only visible on hover */}
                    ...
                    {/* Category Badge - Floating in top-right */}
                    ...
                    {/* View Project Icon - Center overlay on hover */}
                  ...
                  {/* Subtle Border Accent - Only visible on hover */}
